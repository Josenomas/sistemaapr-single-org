...
Route::get('/cambio-plan/{id}/confirmacion', [App\Http\Controllers\OrganizacionController::class, 'confirmacionCambioPlan'])->name('cambio-plan.confirmacion');
...
Route::middleware(['auth', 'superadmin'])->prefix('superadmin')->name('superadmin.')->group(function () {
    ...
    Route::delete('/organizaciones/{id}/eliminar-todos-socios', [App\Http\Controllers\ImportarSociosController::class, 'eliminarTodosSocios'])->name('organizacion.eliminar-todos-socios');
    ...
    Route::get('/exportar-reporte-dte-excel', [App\Http\Controllers\SuperAdminController::class, 'exportarReporteDTEExcel'])->name('exportar-reporte-dte-excel');
    Route::get('/exportar-reporte-dte-pdf', [App\Http\Controllers\SuperAdminController::class, 'exportarReporteDTEPDF'])->name('exportar-reporte-dte-pdf');
});
