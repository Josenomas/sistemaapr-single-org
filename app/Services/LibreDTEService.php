...
class LibreDTEService
{
    ...
    /**
     * Generar imagen PNG del código de barras PDF417 desde TED XML
     * Usa TCPDF para generar PDF417 y convierte a PNG
     *
     * @param string $tedXML El contenido XML del TED
     * @return string|null Base64 de la imagen PNG, o null si falla
     */
    protected function generarImagenPDF417($tedXML)
    {
        try {
            ...
            // Configurar para generar solo el barcode sin página completa
            ...
            // Estilo del código de barras PDF417
            $style = [
                'border' => 0,
                'vpadding' => 0,
                'hpadding' => 0,
            ...
            // Si Imagick está disponible, convertir PDF a PNG de alta calidad
            if (extension_loaded('imagick')) {
                ...
                // Fondo blanco (SII requiere fondo blanco)
            ...
            // Fallback: retornar el PDF como base64
