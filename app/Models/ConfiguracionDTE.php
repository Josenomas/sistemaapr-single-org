...
class ConfiguracionDTE extends Model
{
    ...
    public function estaConfigurado()
    {
        ...
        if ($this->proveedor_dte === 'simpleapi' || $this->proveedor_dte === 'simplefactura') {
            // SimpleAPI y SimpleFactura requieren certificado digital configurado
    ...
    /**
     * Verificar si usa SimpleFactura
     */
    public function usaSimpleFactura()
    {
        return $this->proveedor_dte === 'simplefactura';
    }
