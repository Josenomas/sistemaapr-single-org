...
@section('title', 'Registrar Trabajo - Sistema APR')
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="tipo_trabajo" name="tipo_trabajo" class="form-control @error('tipo_trabajo') error @enderror" required>
                            ...
                            <option value="mantenimiento" {{ old('tipo_trabajo', 'mantenimiento') == 'mantenimiento' ? 'selected' : '' }}>Mantenimiento</option>
                            <option value="reparacion" {{ old('tipo_trabajo') == 'reparacion' ? 'selected' : '' }}>Reparación</option>
                            <option value="instalacion" {{ old('tipo_trabajo') == 'instalacion' ? 'selected' : '' }}>Instalación</option>
                            <option value="inspeccion" {{ old('tipo_trabajo') == 'inspeccion' ? 'selected' : '' }}>Inspección</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ubicacion" name="ubicacion" class="form-control @error('ubicacion') error @enderror"
                               value="{{ old('ubicacion') }}" placeholder="Ej: Estanque principal, Sector Norte">
                        @error('ubicacion')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="costo_estimado" name="costo_estimado"
                               ...
                               value="{{ old('costo_estimado', 0) }}" min="0" step="0.01">
                ...
                <div class="form-row">
                    <div class="form-group full-width">
                        ...
                        <textarea id="materiales_utilizados" name="materiales_utilizados" class="form-control @error('materiales_utilizados') error @enderror"
                                  rows="3">{{ old('materiales_utilizados') }}</textarea>
