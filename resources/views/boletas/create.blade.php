    ...
    <div class="card-body">
        <form action="{{ route('boletas.store') }}" method="POST">
            ...
            <div class="form-section factura-section">
                ...
                <div class="factura-fields" id="facturaFields" style="display: none;">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('razon_social_receptor') }}"
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Auto-expandir si hay errores de validación en campos de factura
        @if($errors->has('rut_receptor') || $errors->has('razon_social_receptor') || $errors->has('giro_receptor') || $errors->has('direccion_receptor') || $errors->has('comuna_receptor'))
            toggleFacturaFields();
        @endif
    });
</script>
