            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ format_lectura($lectura->lectura_anterior) }} m³</td>
                        <td>{{ format_lectura($lectura->lectura_actual) }} m³</td>
                        <td><span class="badge badge-info">{{ format_lectura($lectura->consumo) }} m³</span></td>
