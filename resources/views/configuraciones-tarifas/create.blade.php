...
@section('title', 'Nueva Configuración Tarifaria')
...
<div class="form-container">
    <div class="form-header">
        <h2 class="form-title">
            ...
            Nueva Configuración Tarifaria
        </h2>
    </div>

    <div class="form-card">
        <form action="{{ route('configuraciones-tarifas.store') }}" method="POST">
            @csrf
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    @error('iva')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                    <div class="form-help">Porcentaje de IVA aplicado al monto base</div>
                </div>
