...
@section('title', 'Nuevo Funcionario - Sistema APR')
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="rut" name="rut" class="form-control @error('rut') error @enderror"
                               value="{{ old('rut') }}" placeholder="12.345.678-9" required>
                        @error('rut')
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="cargo" name="cargo" class="form-control @error('cargo') error @enderror"
                               value="{{ old('cargo') }}" placeholder="Ej: Operador, Secretaria, etc." required>
                        @error('cargo')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
