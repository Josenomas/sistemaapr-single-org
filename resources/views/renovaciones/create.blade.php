...
@section('title', 'Registrar Renovación de Medidor - Sistema APR')

@section('content')
<div class="page-header">
    <h2 class="page-title">
        <i class="fas fa-sync-alt"></i>
        Registrar Renovación de Medidor
    </h2>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="lectura_anterior" name="lectura_anterior"
                               ...
                               value="{{ old('lectura_anterior', 0) }}" min="0" step="0.01">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="medidor_nuevo" name="medidor_nuevo"
                               ...
                               value="{{ old('medidor_nuevo') }}" required>
                        @error('medidor_nuevo')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="lectura_inicial" name="lectura_inicial"
                               ...
                               value="{{ old('lectura_inicial', 0) }}" min="0" step="0.01" required>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" id="fecha_renovacion" name="fecha_renovacion"
                               ...
                               value="{{ old('fecha_renovacion', date('Y-m-d')) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <select id="motivo" name="motivo" class="form-control @error('motivo') error @enderror" required>
                            ...
                            <option value="deterioro" {{ old('motivo', 'deterioro') == 'deterioro' ? 'selected' : '' }}>Deterioro</option>
                            <option value="falla" {{ old('motivo') == 'falla' ? 'selected' : '' }}>Falla</option>
                            <option value="actualizacion" {{ old('motivo') == 'actualizacion' ? 'selected' : '' }}>Actualización</option>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="costo_renovacion" name="costo_renovacion"
                               ...
                               value="{{ old('costo_renovacion', 0) }}" min="0" step="0.01">
                    ...
                    <div class="form-group full-width">
                        ...
                        <select id="id_tecnico" name="id_tecnico" class="form-control @error('id_tecnico') error @enderror">
                            ...
                            @foreach($tecnicos as $tecnico)
                                <option value="{{ $tecnico->id }}" {{ old('id_tecnico') == $tecnico->id ? 'selected' : '' }}>
