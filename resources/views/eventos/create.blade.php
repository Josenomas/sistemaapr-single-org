...
@section('title', 'Nuevo Evento - Sistema APR')
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="tipo"
                        ...
                        <option value="FACTURACIÓN" {{ old('tipo') == 'FACTURACIÓN' ? 'selected' : '' }}>Facturación</option>
                        <option value="OPERACIÓN" {{ old('tipo') == 'OPERACIÓN' ? 'selected' : '' }}>Operación</option>
                        <option value="COBRO" {{ old('tipo') == 'COBRO' ? 'selected' : '' }}>Cobro</option>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select name="recurrencia"
                            ...
                            required>
                        <option value="ninguna" {{ old('recurrencia') == 'ninguna' ? 'selected' : '' }}>Evento único</option>
                        <option value="diaria" {{ old('recurrencia') == 'diaria' ? 'selected' : '' }}>Todos los días</option>
                        <option value="semanal" {{ old('recurrencia') == 'semanal' ? 'selected' : '' }}>Cada semana</option>
                        <option value="mensual" {{ old('recurrencia') == 'mensual' ? 'selected' : '' }}>Cada mes</option>
                        <option value="anual" {{ old('recurrencia') == 'anual' ? 'selected' : '' }}>Cada año</option>
                    </select>
                    @error('recurrencia')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group col-md-4" id="dia-recurrencia-group" style="display:none;">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <select name="icono"
                            ...
                            required>
                        <option value="fa-calendar-check" {{ old('icono') == 'fa-calendar-check' ? 'selected' : '' }}>Calendario Check</option>
                        <option value="fa-file-invoice-dollar" {{ old('icono') == 'fa-file-invoice-dollar' ? 'selected' : '' }}>Boletas</option>
                        <option value="fa-tint" {{ old('icono') == 'fa-tint' ? 'selected' : '' }}>Agua</option>
                        <option value="fa-exclamation-triangle" {{ old('icono') == 'fa-exclamation-triangle' ? 'selected' : '' }}>Advertencia</option>
                        <option value="fa-tools" {{ old('icono') == 'fa-tools' ? 'selected' : '' }}>Herramientas</option>
                        <option value="fa-bell" {{ old('icono') == 'fa-bell' ? 'selected' : '' }}>Campana</option>
                        <option value="fa-clipboard-list" {{ old('icono') == 'fa-clipboard-list' ? 'selected' : '' }}>Lista</option>
                    </select>
                    @error('icono')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group col-md-4">
                    ...
                    <select name="color"
                        ...
                        <option value="warning" {{ old('color') == 'warning' ? 'selected' : '' }}>Naranja (Warning)</option>
